  ...
  module Models
    class User
      attr_accessor :user_id, :login_id, :status, :first_name, :last_name,
                    ...
                    :authentication_provider_id, :sis_batch_id, :school_id, :ext_id
      ...
      def initialize(user_id:, login_id:, status:, first_name: nil, last_name: nil,
                     ...
                     sis_batch_id: nil, lineno: nil, csv: nil, school_id: nil, ext_id: nil)
      ...
      def to_a
        [user_id.to_s, login_id.to_s, status, first_name, last_name, email,
         ...
         full_name, sortable_name, authentication_provider_id, school_id, ext_id]
      end
    end
  end
end
